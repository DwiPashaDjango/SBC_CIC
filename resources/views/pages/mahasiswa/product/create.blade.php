...
<div class="card card-primary">
    ...
    <div class="card-body">
        <form action="{{route('mhs.product.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                ...
                <div class="col-12">
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" value="{{old('harga_jual')}}" class="form-control @error('harga_jual') is-invalid @enderror" name="harga_jual" id="harga_jual">
                            @error('harga_jual')
                                <span class="invalid-feedback">
                                    {{$message}}
                                </span>
